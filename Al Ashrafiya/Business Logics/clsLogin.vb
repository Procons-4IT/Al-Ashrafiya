    ...
    Private Sub LoadForm()
        ...
        Try
            ...
            For intRow As Integer = 0 To otemp.RecordCount - 1
                oCombobox.ValidValues.Add(otemp.Fields.Item(0).Value, otemp.Fields.Item(0).Value)
                otemp.MoveNext()
            Next
...
#Region "AddMode"
    Private Sub AddMode(ByVal aForm As SAPbouiCOM.Form)
        ...
        If aForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Then
            strCode = oApplication.Utilities.getMaxCode("@Z_AL_OADM", "DocEntry")
...
#Region "Validations"
    Private Function Validation(ByVal aForm As SAPbouiCOM.Form) As Boolean
        ...
        Catch ex As Exception
            oApplication.Utilities.Message("Branch  Code is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End Try
        ...
        If aForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE Or aForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE Then
            Dim otemp As SAPbobsCOM.Recordset
            otemp = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
            otemp.DoQuery("Select * from [@Z_AL_OADM] where docentry<>" & oApplication.Utilities.getEdittextvalue(aForm, "4") & " and  U_Z_BraDB='" & oCombobox.Selected.Value & "'")
        ...
        If oApplication.Utilities.getEdittextvalue(aForm, "8") = "" Then
            oApplication.Utilities.Message("User ID is missing...", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Return False
        End If
        ...
        If oApplication.Utilities.CheckConnection(oCombobox.Selected.Value, oApplication.Utilities.getEdittextvalue(aForm, "8"), oApplication.Utilities.getEdittextvalue(aForm, "10")) = False Then
            Return False
        End If
...
#Region "AddRow /Delete Row"
    Private Sub AddRow(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            oMatrix = aForm.Items.Item("7").Specific
            oDataSrc_Line = aForm.DataSources.DBDataSources.Item("@Z_AL_OADM1")
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Setup Then
